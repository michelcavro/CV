...
$(document).ready(function (){
	...
	var stickyFd = function(){
		...
		if (scrollTop > stickyFond) { 
		    $('.fondTitre').addClass('fondTitreGris');
		} else {
		    $('.fondTitre').removeClass('fondTitreGris'); 
		}
	};
	 // APPELE LA FONCTION
	stickyFd();
